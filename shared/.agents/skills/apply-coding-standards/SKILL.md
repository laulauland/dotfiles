...
description: Apply the user's coding standards while designing, writing, or reviewing TypeScript, React, Cloudflare, Effect, and cross-language code. Use when changing domain models, modules, boundaries, errors, async work, tests, contracts, naming, or control flow.
---
