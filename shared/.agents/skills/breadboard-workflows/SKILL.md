---
name: breadboard-workflows
description: Breadboard a workflow as UI and code affordances with explicit wiring. Use to map an existing system, detail a shaped solution, translate a whiteboard, or slice a breadboard for delivery.
---
