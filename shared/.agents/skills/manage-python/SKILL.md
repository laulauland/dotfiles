---
name: manage-python
description: Manage Python projects, dependencies, environments, interpreters, scripts, and tools with uv. Use when creating or migrating a Python project, changing dependencies, selecting Python versions, or repairing its development workflow.
---
