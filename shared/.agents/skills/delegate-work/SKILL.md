---
name: delegate-work
description: Delegate all substantive work to background subagents while the primary agent only coordinates and synthesizes.
---
...
- `fable` — almost never for minion work; reserve the top tier for the
  coordinator's own work, not token-expensive delegated tasks.
