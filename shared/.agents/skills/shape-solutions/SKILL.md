...
description: Shape a solution with the user by iterating between requirements, candidate shapes, fit checks, breadboards, and implementation slices. Use to clarify a problem, compare options, or continue an existing shaping document.
---
