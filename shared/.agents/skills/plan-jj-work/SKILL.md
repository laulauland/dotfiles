---
name: plan-jj-work
description: Plan and execute staged work as empty jj revisions whose descriptions carry goals, acceptance criteria, scope, verification, and deviations. Use when turning a spec into phased or sliced work in a jj repository or continuing such a plan.
...
**implement → review → fix loop**: implement, run a review with `/review-code`,
