---
description: >-
  Use this agent to gather context before implementation. The librarian finds
  information from two sources: the codebase (files, patterns, existing
  implementations) and external documentation (APIs, libraries, packages).
  ...
  - <example>
      Context: User needs to add a feature requiring both codebase context and external API knowledge
